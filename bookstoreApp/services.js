// SERVICES
bookStoreApp.service('bookService', function () {
  this.books = [
    {
  ...
  this.chosen = function (title) {
    function search(title, books){
    ...
    return search(title, this.books);
  }

  /* Add a new book in the Book List and return the new list */
